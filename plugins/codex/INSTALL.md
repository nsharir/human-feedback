# Codex — human-feedback in AGENTS.md
...
A section in `AGENTS.md` wrapped in `<!-- human-feedback:begin -->` / `<!-- human-feedback:end -->` markers. Existing content in `AGENTS.md` is preserved. Uninstall removes only the marked section.
...
```
use human-feedback to review the spec
```

## Manual install

Copy the content of `human-feedback.agents-section.md` from this directory and paste it into your `AGENTS.md`.
